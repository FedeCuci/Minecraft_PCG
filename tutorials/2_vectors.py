...
editor.placeBlock((74,64,-28), Block("red_concrete"))
...
editor.placeBlock((74,64,-27),           Block("blue_concrete"))
editor.placeBlock([74,64,-26],           Block("green_concrete"))
editor.placeBlock(np.array([74,64,-25]), Block("yellow_concrete"))
